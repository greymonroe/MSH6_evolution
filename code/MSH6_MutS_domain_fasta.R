...
sequences <- readAAStringSet(filepath = "/all.faa")

interpro<-read_interproscan("data/all.faa.tsv")

#orthos<-fread("data/potential_orthologs_mismatch.txt") # run to see other MSH6 orthologs
orthos<-fread("data/predicted_msh6_blast.txt")
